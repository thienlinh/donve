...
export function SaveAsTemplateDialog({
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setName("");
      setIndustry("");
      toast.add({ title: "Đã lưu làm template", type: "success" });
    },
    onError: () => toast.add({ title: "Lưu template thất bại", type: "error" })
  });
      ...
      <DialogTrigger
        render={
          <Button variant="outline" size="sm">
            <BookmarkPlus /> Lưu làm template
          </Button>
        }
      />
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Lưu trang này làm template</DialogTitle>
        </DialogHeader>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="VD: SaaS, Ecommerce, Dịch vụ local…"
            />
          </div>
          <Button
            disabled={
