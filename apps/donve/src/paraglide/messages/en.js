...
export const aiconnectdialogtitle3 =
  /** @type {(inputs: Aiconnectdialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Connect an API key`);
  };

export const aiconnectguidetitle3 =
  /** @type {(inputs: Aiconnectguidetitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`How to get this key`);
  };

export const aiconnectsubmit2 =
  /** @type {(inputs: Aiconnectsubmit2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Connect`);
  };

export const aiconnectioncolumnactions3 =
  /** @type {(inputs: Aiconnectioncolumnactions3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Actions`);
  };

export const aiconnectioncolumnmodel3 =
  /** @type {(inputs: Aiconnectioncolumnmodel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Default model`);
  };

export const aiconnectioncolumnprovider3 =
  /** @type {(inputs: Aiconnectioncolumnprovider3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Provider`);
  };

export const aiconnectioncolumnstatus3 =
  /** @type {(inputs: Aiconnectioncolumnstatus3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Status`);
  };

export const aiconnectiondefaultbadge3 =
  /** @type {(inputs: Aiconnectiondefaultbadge3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Default`);
  };

export const aiconnectionstatusactive3 =
  /** @type {(inputs: Aiconnectionstatusactive3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Active`);
  };

export const aiconnectionstatusinvalid3 =
  /** @type {(inputs: Aiconnectionstatusinvalid3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Key invalid`);
  };

export const aiconnectionsdescription2 =
...
export const aiproviderdescriptionanthropic3 =
  /** @type {(inputs: Aiproviderdescriptionanthropic3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Connects directly to Claude — highest quality for copywriting, but you create the key yourself on console.anthropic.com.`
    );
  };

export const aiproviderdescriptiongroq3 =
  /** @type {(inputs: Aiproviderdescriptiongroq3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Very fast responses, good for small actions like renaming a layer or a quick chat reply.`
    );
  };

export const aiproviderdescriptionnvidia3 =
  /** @type {(inputs: Aiproviderdescriptionnvidia3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `A wide model catalog from NVIDIA, with free models to try.`
    );
  };

export const aiproviderdescriptionopenai3 =
  /** @type {(inputs: Aiproviderdescriptionopenai3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Connects directly to GPT — you create the key yourself on platform.openai.com.`
    );
  };

export const aiproviderdescriptionopenrouter3 =
  /** @type {(inputs: Aiproviderdescriptionopenrouter3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `One key works with many models, including a free one to try first.`
    );
  };

export const aiproviderlabel2 =
  /** @type {(inputs: Aiproviderlabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Provider`);
  };

export const airemoveconfirmbody3 =
...
export const auditlogemptytitle3 =
  /** @type {(inputs: Auditlogemptytitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No audit log entries yet`);
  };

export const auditlogloaderrortitle4 =
  /** @type {(inputs: Auditlogloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed to load audit log`);
  };

export const auditlogtitle2 =
  /** @type {(inputs: Auditlogtitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Audit log`);
  };

export const authsidedescription2 =
  /** @type {(inputs: Authsidedescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Đơn Về brings content, customers, payments, and fulfillment into one clear flow.`
    );
  };

export const authsidetitle2 =
  /** @type {(inputs: Authsidetitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`A lighter way to sell every day`);
  };

export const authvaluelead2 =
  /** @type {(inputs: Authvaluelead2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Never miss a new lead`);
  };

export const authvaluenext2 =
  /** @type {(inputs: Authvaluenext2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Always know what to do next`);
  };

export const authvaluepayment2 =
  /** @type {(inputs: Authvaluepayment2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Know when money arrives`);
  };

export const campaignsaccountnamelabel3 =
  /** @type {(inputs: Campaignsaccountnamelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Account name`);
  };

export const campaignsaccountnumberlabel3 =
  /** @type {(inputs: Campaignsaccountnumberlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Account number`);
  };

export const campaignsactionduplicate2 =
  /** @type {(inputs: Campaignsactionduplicate2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Duplicate campaign`);
  };

export const campaignsaddbutton2 =
  /** @type {(inputs: Campaignsaddbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add campaign`);
  };

export const campaignsadddialogtitle3 =
  /** @type {(inputs: Campaignsadddialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add a campaign`);
  };

export const campaignsanalyticsaction2 =
  /** @type {(inputs: Campaignsanalyticsaction2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`View analytics`);
  };

export const campaignsanalyticsbysourceempty4 =
  /** @type {(inputs: Campaignsanalyticsbysourceempty4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `No tagged traffic in the last 30 days.`
    );
  };

export const campaignsanalyticsbysourcetitle4 =
  /** @type {(inputs: Campaignsanalyticsbysourcetitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`By traffic source`);
  };

export const campaignsanalyticsconversion2 =
  /** @type {(inputs: Campaignsanalyticsconversion2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Conversion`);
  };

export const campaignsanalyticsdescription2 =
...
export const campaignsanalyticsloaderrortitle4 =
  /** @type {(inputs: Campaignsanalyticsloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load analytics`);
  };

export const campaignsanalyticsorders2 =
  /** @type {(inputs: Campaignsanalyticsorders2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Orders`);
  };

export const campaignsanalyticsrevenue2 =
  /** @type {(inputs: Campaignsanalyticsrevenue2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Revenue (VND)`);
  };

export const campaignsanalyticssourcecolumn3 =
  /** @type {(inputs: Campaignsanalyticssourcecolumn3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Source`);
  };

export const campaignsanalyticssubmits2 =
  /** @type {(inputs: Campaignsanalyticssubmits2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Submits`);
  };

export const campaignsanalyticstitle2 =
  /** @type {(inputs: Campaignsanalyticstitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Campaign analytics`);
  };

export const campaignsanalyticsviews2 =
  /** @type {(inputs: Campaignsanalyticsviews2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Views`);
  };

export const campaignsassignmentmodelabel3 =
  /** @type {(inputs: Campaignsassignmentmodelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Lead assignment`);
  };

export const campaignsassignmentmodemanual3 =
  /** @type {(inputs: Campaignsassignmentmodemanual3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manual`);
  };

export const campaignsassignmentmoderoundrobin4 =
  /** @type {(inputs: Campaignsassignmentmoderoundrobin4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Round-robin (auto)`);
  };

export const campaignsbankbinlabel3 =
  /** @type {(inputs: Campaignsbankbinlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Bank BIN`);
  };

export const campaignsbulkchangestatus3 =
  /** @type {(inputs: Campaignsbulkchangestatus3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Change status`);
  };

export const campaignsbulkclearselection3 =
  /** @type {(inputs: Campaignsbulkclearselection3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Clear selection`);
  };

export const campaignsbulkdelete2 =
  /** @type {(inputs: Campaignsbulkdelete2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Delete`);
  };

export const campaignsbulkdeleteconfirm3 =
  /** @type {(inputs: Campaignsbulkdeleteconfirm3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Delete`);
  };

export const campaignsbulkdeleteconfirmdescription4 =
  /** @type {(inputs: Campaignsbulkdeleteconfirmdescription4Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `This will permanently delete ${i?.count} campaign(s).`
    );
  };

export const campaignsbulkdeleteconfirmtitle4 =
  /** @type {(inputs: Campaignsbulkdeleteconfirmtitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Delete selected campaigns?`);
  };

export const campaignsbulkdeleteerrortoast4 =
  /** @type {(inputs: Campaignsbulkdeleteerrortoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Couldn't delete the selected campaigns. Try again.`
    );
  };

export const campaignsbulkselectedcount3 =
  /** @type {(inputs: Campaignsbulkselectedcount3Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (`${i?.count} campaign(s) selected`);
  };

export const campaignsbulkstatuserrortoast4 =
  /** @type {(inputs: Campaignsbulkstatuserrortoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Couldn't change status for the selected campaigns. Try again.`
    );
  };

export const campaignscolumnactions2 =
  /** @type {(inputs: Campaignscolumnactions2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Actions`);
  };

export const campaignscolumnname2 =
  /** @type {(inputs: Campaignscolumnname2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Name`);
  };

export const campaignscolumnproducts2 =
  /** @type {(inputs: Campaignscolumnproducts2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Products`);
  };

export const campaignscolumnstatus2 =
  /** @type {(inputs: Campaignscolumnstatus2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Status`);
  };

export const campaignsdescription1 =
...
export const campaignsdialogdescription2 =
...
export const campaignsformfieldssectiontitle4 =
  /** @type {(inputs: Campaignsformfieldssectiontitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Form fields`);
  };

export const campaignsgoallabel2 =
  /** @type {(inputs: Campaignsgoallabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Goal`);
  };

export const campaignsloaderrortitle3 =
  /** @type {(inputs: Campaignsloaderrortitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load campaigns`);
  };

export const campaignsnamelabel2 =
  /** @type {(inputs: Campaignsnamelabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Name`);
  };

export const campaignsogimagecreatefirsthint5 =
  /** @type {(inputs: Campaignsogimagecreatefirsthint5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Save the campaign first, then reopen it to upload a share image.`
    );
  };

export const campaignsogimagedescription3 =
  /** @type {(inputs: Campaignsogimagedescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `The preview image shown when this campaign’s landing page is shared on social media.`
    );
  };

export const campaignsogimagelabel3 =
  /** @type {(inputs: Campaignsogimagelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`OG image`);
  };

export const campaignsogimagesectiontitle4 =
  /** @type {(inputs: Campaignsogimagesectiontitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Social share image`);
  };

export const campaignspaymentenabledlabel3 =
  /** @type {(inputs: Campaignspaymentenabledlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Enabled`);
  };

export const campaignspaymentsectiontitle3 =
  /** @type {(inputs: Campaignspaymentsectiontitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Payment`);
  };

export const campaignspopupbodylabel3 =
  /** @type {(inputs: Campaignspopupbodylabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Popup body`);
  };

export const campaignspopupmanualpendingtitle4 =
...
export const campaignsremoveconfirmtitle3 =
...
export const campaignsremoveerrortoast3 =
...
export const campaignssaveerrortoast3 =
...
export const commonretry1 =
  /** @type {(inputs: Commonretry1Inputs) => LocalizedString} */ () => {
...
export const domainsadddialogdescription3 =
  /** @type {(inputs: Domainsadddialogdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Pick a published landing page and enter the domain you already own (e.g. shop.yourbrand.com). Once added, we'll show you the values to enter at your domain provider.`
    );
  };

export const domainsadddialogtitle3 =
  /** @type {(inputs: Domainsadddialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add a custom domain`);
  };

export const domainsadderrortoast3 =
...
export const domainsaddsubmit2 =
  /** @type {(inputs: Domainsaddsubmit2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add domain`);
  };

export const domainscnamehostlabel3 =
  /** @type {(inputs: Domainscnamehostlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Record name (Host)`);
  };

export const domainscnamevaluelabel3 =
  /** @type {(inputs: Domainscnamevaluelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Value`);
  };

export const domainscolumnactions2 =
  /** @type {(inputs: Domainscolumnactions2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Actions`);
  };

export const domainscolumnhostname2 =
  /** @type {(inputs: Domainscolumnhostname2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Domain`);
  };

export const domainscolumnstatus2 =
  /** @type {(inputs: Domainscolumnstatus2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Status`);
  };

export const domainsdescription1 =
  /** @type {(inputs: Domainsdescription1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Use your own domain (e.g. shop.yourbrand.com) for a published landing page instead of Đơn Về's default one. The security certificate (SSL) is issued automatically — you just need 1-2 steps at wherever you bought the domain.`
    );
  };

export const domainsdnsinstructionsintro3 =
  /** @type {(inputs: Domainsdnsinstructionsintro3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Go to your domain's management page (GoDaddy, Namecheap, etc.) and add this CNAME record:`
    );
  };

export const domainsemptytitle2 =
  /** @type {(inputs: Domainsemptytitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No custom domain yet`);
  };

export const domainshostnamelabel2 =
  /** @type {(inputs: Domainshostnamelabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Domain`);
  };

export const domainslandingpagelabel3 =
  /** @type {(inputs: Domainslandingpagelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Landing page`);
  };

export const domainslandingpageplaceholder3 =
...
export const domainsremoveconfirmtitle3 =
...
export const domainsremoveerrortoast3 =
...
export const domainsstatusactive2 =
  /** @type {(inputs: Domainsstatusactive2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Active`);
  };

export const domainsstatusfailed2 =
  /** @type {(inputs: Domainsstatusfailed2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Failed`);
  };

export const domainsstatuspending2 =
  /** @type {(inputs: Domainsstatuspending2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Pending`);
  };

export const domainstitle1 =
  /** @type {(inputs: Domainstitle1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Custom domains`);
  };

export const domainstxthostlabel3 =
  /** @type {(inputs: Domainstxthostlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Record name (Host)`);
  };

export const domainstxtinstructionsintro3 =
  /** @type {(inputs: Domainstxtinstructionsintro3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `To verify you own the domain, also add this TXT record:`
    );
  };

export const domainstxtvaluelabel3 =
  /** @type {(inputs: Domainstxtvaluelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Value`);
  };
...
export const domainsvaluecopiedtoast3 =
  /** @type {(inputs: Domainsvaluecopiedtoast3Inputs) => LocalizedString} */ () => {
...
export const domainsverifyerrortoast3 =
...
export const entityimagedrophint3 =
  /** @type {(inputs: Entityimagedrophint3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`or drag and drop an image here`);
  };

export const entityimageremovelabel3 =
  /** @type {(inputs: Entityimageremovelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Remove image`);
  };

export const entityimageuploadfailed3 =
  /** @type {(inputs: Entityimageuploadfailed3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Could not save the image. Please try again.`
    );
  };

export const entityimageuploadlabel3 =
  /** @type {(inputs: Entityimageuploadlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Choose image`);
  };
...
export const landingsbadgedraft2 =
  /** @type {(inputs: Landingsbadgedraft2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Draft`);
  };

export const landingsbadgepublished2 =
  /** @type {(inputs: Landingsbadgepublished2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Published`);
  };

export const landingscardactionslabel3 =
  /** @type {(inputs: Landingscardactionslabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Landing page actions`);
  };

export const landingscreateaibutton3 =
  /** @type {(inputs: Landingscreateaibutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create with AI`);
  };

export const landingscreateaidescription3 =
  /** @type {(inputs: Landingscreateaidescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Describe the product and AI handles the first draft`
    );
  };

export const landingscreateaititle3 =
  /** @type {(inputs: Landingscreateaititle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`AI creates the landing page`);
  };

export const landingscreateerrortoast3 =
...
export const landingscreateheading2 =
  /** @type {(inputs: Landingscreateheading2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `How do you want to create your first landing page?`
    );
  };

export const landingscreateimportdescription3 =
  /** @type {(inputs: Landingscreateimportdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Upload a folder, paste HTML, or enter a URL`
    );
  };

export const landingscreateimporttitle3 =
  /** @type {(inputs: Landingscreateimporttitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Use an existing page`);
  };

export const landingscreatemanualbutton3 =
  /** @type {(inputs: Landingscreatemanualbutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create manually`);
  };

export const landingscreatemanualdescription3 =
  /** @type {(inputs: Landingscreatemanualdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Start from a blank canvas and pick each section`
    );
  };

export const landingscreatemanualtitle3 =
  /** @type {(inputs: Landingscreatemanualtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Design the landing page yourself`);
  };

export const landingsfilterall2 =
  /** @type {(inputs: Landingsfilterall2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`All`);
  };

export const landingsfilterallcampaigns3 =
  /** @type {(inputs: Landingsfilterallcampaigns3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`All campaigns`);
  };

export const landingsfilterdraft2 =
  /** @type {(inputs: Landingsfilterdraft2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Draft`);
  };

export const landingsfilterpublished2 =
  /** @type {(inputs: Landingsfilterpublished2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Published`);
  };

export const landingsimportbutton2 =
  /** @type {(inputs: Landingsimportbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Import`);
  };

export const landingsimportdialogtitle3 =
  /** @type {(inputs: Landingsimportdialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Import landing page`);
  };

export const landingsimporterrortoast3 =
...
export const landingsreuploadbutton2 =
  /** @type {(inputs: Landingsreuploadbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Re-upload content`);
  };

export const landingsreuploaddialogtitle3 =
  /** @type {(inputs: Landingsreuploaddialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Re-upload landing page`);
  };

export const landingssearchplaceholder2 =
...
export const landingssortupdated2 =
  /** @type {(inputs: Landingssortupdated2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Recently updated`);
  };

export const landingssummarycount2 =
  /** @type {(inputs: Landingssummarycount2Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `${i?.total} landing pages · ${i?.published} live`
    );
  };

export const landingsupdatedat2 =
  /** @type {(inputs: Landingsupdatedat2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Updated`);
  };

export const leadsourcecsvimport3 =
  /** @type {(inputs: Leadsourcecsvimport3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`CSV import`);
  };

export const leadsourcedirect2 =
  /** @type {(inputs: Leadsourcedirect2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Direct`);
  };

export const leadsourcefacebook2 =
  /** @type {(inputs: Leadsourcefacebook2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Facebook`);
  };

export const leadsourcegeneric2 =
  /** @type {(inputs: Leadsourcegeneric2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Other`);
  };

export const leadsourcegoogleads3 =
  /** @type {(inputs: Leadsourcegoogleads3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Google Ads`);
  };

export const leadsourcelandingpage3 =
  /** @type {(inputs: Leadsourcelandingpage3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Landing page`);
  };

export const leadsourcemanual2 =
  /** @type {(inputs: Leadsourcemanual2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Manual entry`);
  };

export const leadsourcetiktok2 =
  /** @type {(inputs: Leadsourcetiktok2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`TikTok`);
  };

export const leadsourcezalooa3 =
  /** @type {(inputs: Leadsourcezalooa3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Zalo OA`);
  };

export const leadsactioncall2 =
  /** @type {(inputs: Leadsactioncall2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Call`);
  };

export const leadsactioncopiedtoast3 =
  /** @type {(inputs: Leadsactioncopiedtoast3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Phone number copied`);
  };

export const leadsactioncopyphone3 =
  /** @type {(inputs: Leadsactioncopyphone3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Copy phone`);
  };

export const leadsactionzalo2 =
  /** @type {(inputs: Leadsactionzalo2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Zalo`);
  };

export const leadsactivitycall2 =
  /** @type {(inputs: Leadsactivitycall2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Call`);
  };

export const leadsactivitynote2 =
  /** @type {(inputs: Leadsactivitynote2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Note`);
  };

export const leadsactivityordercreated3 =
  /** @type {(inputs: Leadsactivityordercreated3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Order created`);
  };

export const leadsactivitypayment2 =
  /** @type {(inputs: Leadsactivitypayment2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Payment confirmed`);
  };

export const leadsactivityresubmit2 =
  /** @type {(inputs: Leadsactivityresubmit2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Resubmitted`);
  };

export const leadsactivitystagechange3 =
  /** @type {(inputs: Leadsactivitystagechange3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Stage changed`);
  };

export const leadsactivitysystem2 =
  /** @type {(inputs: Leadsactivitysystem2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`System update`);
  };

export const leadsaddnotelabel3 =
  /** @type {(inputs: Leadsaddnotelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add a note`);
  };

export const leadsaddnoteplaceholder3 =
  /** @type {(inputs: Leadsaddnoteplaceholder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Write a note about this lead...`);
  };

export const leadsaddnotesubmit3 =
  /** @type {(inputs: Leadsaddnotesubmit3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add note`);
  };

export const leadsagedays2 =
  /** @type {(inputs: Leadsagedays2Inputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`${i?.days}d`);
  };

export const leadsagehours2 =
  /** @type {(inputs: Leadsagehours2Inputs) => LocalizedString} */ (i) => {
    return /** @type {LocalizedString} */ (`${i?.hours}h`);
  };

export const leadsassignerrortoast3 =
...
export const leadsassignmentslabreachlabel4 =
  /** @type {(inputs: Leadsassignmentslabreachlabel4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`On SLA breach`);
  };

export const leadsassignmentslabreachnone4 =
  /** @type {(inputs: Leadsassignmentslabreachnone4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Do nothing`);
  };

export const leadsassignmentslabreachnotify4 =
  /** @type {(inputs: Leadsassignmentslabreachnotify4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Notify the manager`);
  };

export const leadsassignmentslabreachreassign4 =
  /** @type {(inputs: Leadsassignmentslabreachreassign4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Reassign to the next person in the pool`
    );
  };

export const leadsassignmentslalabel3 =
  /** @type {(inputs: Leadsassignmentslalabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`SLA (hours, optional)`);
  };

export const leadsassignmentstrategyfixed3 =
  /** @type {(inputs: Leadsassignmentstrategyfixed3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Fixed assignee`);
  };

export const leadsassignmentstrategylabel3 =
  /** @type {(inputs: Leadsassignmentstrategylabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Strategy`);
  };

export const leadsassignmentstrategyleastactive4 =
  /** @type {(inputs: Leadsassignmentstrategyleastactive4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Least active leads`);
  };

export const leadsassignmentstrategyroundrobin4 =
  /** @type {(inputs: Leadsassignmentstrategyroundrobin4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Round robin`);
  };

export const leadsbulkassignerrortoast4 =
...
export const leadsbulkstageerrortoast4 =
...
export const leadsdsrcreateerrortoast4 =
...
export const leadsnotifyesmsdescription3 =
...
export const leadsnotifyznsdescription3 =
  /** @type {(inputs: Leadsnotifyznsdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Your own Zalo ZNS app — paste the access token you obtained via Zalo's OAuth flow, and the template ID Zalo approved. Your template must use the field names lead_name, sla_hours, org_name.`
    );
  };

export const leadsnotifyznstemplateidlabel5 =
  /** @type {(inputs: Leadsnotifyznstemplateidlabel5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Template ID`);
  };

export const leadsnotifyznstemplateidplaceholder5 =
...
export const leadswebhookconfiguredbadge3 =
  /** @type {(inputs: Leadswebhookconfiguredbadge3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Configured`);
  };

export const leadswebhookgenericdescription3 =
  /** @type {(inputs: Leadswebhookgenericdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Use for any lead source with no dedicated integration above (a Zalo Mini App bridge server, a custom CRM, an automation tool...). Authenticated by a plain API key instead of a signature — paste it into the Authorization: Bearer <key> header.`
    );
  };

export const leadswebhookgenericgeneratebutton4 =
  /** @type {(inputs: Leadswebhookgenericgeneratebutton4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Generate API Key`);
  };

export const leadswebhookgenerickeyrevealedlabel5 =
  /** @type {(inputs: Leadswebhookgenerickeyrevealedlabel5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Your API Key`);
  };

export const leadswebhookgenerickeyrevealedwarning5 =
...
export const leadswebhooknocampaignsempty4 =
...
export const leadswebhookpageaccesstokendescription5 =
  /** @type {(inputs: Leadswebhookpageaccesstokendescription5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Required to fetch real form data from Facebook — the webhook only announces a new lead (leadgen_id), this token is what lets us call back into the Graph API for the name/phone.`
    );
  };

export const leadswebhookpageaccesstokenlabel5 =
  /** @type {(inputs: Leadswebhookpageaccesstokenlabel5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Page Access Token`);
  };

export const leadswebhookpageaccesstokenplaceholder5 =
...
export const leadswebhookremovebutton3 =
...
export const leadswebhookremovedtoast3 =
...
export const leadswebhooksecretrotateplaceholder4 =
...
export const leadswebhooksettingsdescription3 =
...
export const memberscancelinviteconfirmtitle4 =
...
export const membersremoveconfirmtitle3 =
...
export const membersremovesuccesstoast3 =
  /** @type {(inputs: Membersremovesuccesstoast3Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `${i?.member} removed from the organization`
    );
  };

export const membersrolelabel2 =
  /** @type {(inputs: Membersrolelabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Role`);
  };

export const membersseeallleadserrortoast5 =
...
export const memberstitle1 =
  /** @type {(inputs: Memberstitle1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Members`);
  };

export const offerworkspaceback2 =
  /** @type {(inputs: Offerworkspaceback2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Back to Offers`);
  };

export const offerworkspacecampaign2 =
  /** @type {(inputs: Offerworkspacecampaign2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Campaign`);
  };

export const offerworkspacecontentmissing3 =
  /** @type {(inputs: Offerworkspacecontentmissing3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `No content yet. Start with a few lines about the product.`
    );
  };

export const offerworkspacecontentready3 =
  /** @type {(inputs: Offerworkspacecontentready3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `A content version is ready to edit.`
    );
  };

export const offerworkspacecontenttitle3 =
  /** @type {(inputs: Offerworkspacecontenttitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Offer content`);
  };

export const offerworkspacedescription2 =
  /** @type {(inputs: Offerworkspacedescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Keep the content, lead source, and next step for this Offer in one place.`
    );
  };

export const offerworkspacedraft2 =
  /** @type {(inputs: Offerworkspacedraft2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Draft`);
  };

export const offerworkspaceeditoraction3 =
  /** @type {(inputs: Offerworkspaceeditoraction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Open editor`);
  };

export const offerworkspaceemptytitle3 =
  /** @type {(inputs: Offerworkspaceemptytitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Offer not found`);
  };

export const offerworkspaceeyebrow2 =
  /** @type {(inputs: Offerworkspaceeyebrow2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Offer workspace`);
  };

export const offerworkspaceinboxaction3 =
  /** @type {(inputs: Offerworkspaceinboxaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Open Inbox`);
  };

export const offerworkspaceloaderrortitle4 =
  /** @type {(inputs: Offerworkspaceloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load this Offer`);
  };

export const offerworkspacenexttitle3 =
  /** @type {(inputs: Offerworkspacenexttitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Next steps`);
  };

export const offerworkspacenocampaign3 =
  /** @type {(inputs: Offerworkspacenocampaign3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No campaign linked`);
  };

export const offerworkspaceready2 =
  /** @type {(inputs: Offerworkspaceready2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Content ready`);
  };

export const offerworkspacestepcontent3 =
  /** @type {(inputs: Offerworkspacestepcontent3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Finish the content`);
  };

export const offerworkspacestepleadform4 =
  /** @type {(inputs: Offerworkspacestepleadform4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Check the lead form`);
  };

export const offerworkspacesteppublish3 =
  /** @type {(inputs: Offerworkspacesteppublish3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Review before publishing`);
  };

export const offerworkspaceversion2 =
  /** @type {(inputs: Offerworkspaceversion2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Version`);
  };

export const offerssurfacenotice2 =
  /** @type {(inputs: Offerssurfacenotice2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
...
export const onboardingchecklistdismiss2 =
  /** @type {(inputs: Onboardingchecklistdismiss2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Dismiss this path`);
  };

export const onboardingchecklistsubtitle2 =
...
export const onboardingchecklisttitle2 =
  /** @type {(inputs: Onboardingchecklisttitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Your starting path`);
  };

export const onboardingcreateerror2 =
...
export const onboardingdeliverylabel2 =
  /** @type {(inputs: Onboardingdeliverylabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`How will you deliver it?`);
  };

export const onboardingdeliverylink2 =
  /** @type {(inputs: Onboardingdeliverylink2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Send a link or document`);
  };

export const onboardingdeliverymanual2 =
  /** @type {(inputs: Onboardingdeliverymanual2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`I will deliver it myself`);
  };

export const onboardingdeliveryschedule2 =
  /** @type {(inputs: Onboardingdeliveryschedule2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Book an appointment`);
  };

export const onboardingdeliveryzalo2 =
  /** @type {(inputs: Onboardingdeliveryzalo2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Invite customers to a Zalo group`);
  };

export const onboardingdescriptionlabel2 =
  /** @type {(inputs: Onboardingdescriptionlabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Short description`);
  };

export const onboardingdescriptionplaceholder2 =
  /** @type {(inputs: Onboardingdescriptionplaceholder2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `What will the customer receive? Write one to three clear sentences.`
    );
  };

export const onboardingorgnamehelp3 =
  /** @type {(inputs: Onboardingorgnamehelp3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `This name appears in your store and customer notifications.`
    );
  };

export const onboardingorgnamelabel3 =
  /** @type {(inputs: Onboardingorgnamelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Store name`);
  };

export const onboardingorgnameplaceholder3 =
  /** @type {(inputs: Onboardingorgnameplaceholder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Example: Yoga with Linh`);
  };

export const onboardingpricehelp2 =
  /** @type {(inputs: Onboardingpricehelp2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`You can change this later.`);
  };

export const onboardingpricelabel2 =
  /** @type {(inputs: Onboardingpricelabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Price (VND)`);
  };

export const onboardingprivacynote2 =
  /** @type {(inputs: Onboardingprivacynote2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `You do not need to connect AI or a bank account yet.`
    );
  };

export const onboardingproductnamelabel3 =
  /** @type {(inputs: Onboardingproductnamelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Product or service name`);
  };

export const onboardingproductnameplaceholder3 =
  /** @type {(inputs: Onboardingproductnameplaceholder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Example: 4-week yoga course`);
  };

export const onboardingproducttypelabel3 =
  /** @type {(inputs: Onboardingproducttypelabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`What are you selling?`);
  };

export const onboardingsetupdescription2 =
  /** @type {(inputs: Onboardingsetupdescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Đơn Về creates a draft sales page and customer form for you to review before publishing.`
    );
  };

export const onboardingsetuptitle2 =
  /** @type {(inputs: Onboardingsetuptitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Start with what you already sell`);
  };

export const onboardingstepconnectai3 =
...
export const onboardingstepconnectpayment3 =
...
export const onboardingstepcreatelanding3 =
...
export const onboardingstepcreateproduct3 =
  /** @type {(inputs: Onboardingstepcreateproduct3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create the product and price`);
  };

export const onboardingsteppublishlanding3 =
  /** @type {(inputs: Onboardingsteppublishlanding3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Review and publish the sales page`);
  };

export const onboardingsubmit1 =
  /** @type {(inputs: Onboardingsubmit1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create sales page`);
  };

export const onboardingtitle1 =
...
export const orgswitchercreateorg3 =
  /** @type {(inputs: Orgswitchercreateorg3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create a new store`);
  };

export const orgswitchernoorg3 =
  /** @type {(inputs: Orgswitchernoorg3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No store yet`);
  };

export const orgswitcherswitcherror3 =
...
export const paymentremoveconfirmtitle3 =
  /** @type {(inputs: Paymentremoveconfirmtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Remove this connection?`);
  };

export const paymentremoveconnectionaction3 =
  /** @type {(inputs: Paymentremoveconnectionaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Remove connection`);
  };

export const paymentremoveconnectionerrortoast4 =
...
export const platformactiondonetoast3 =
  /** @type {(inputs: Platformactiondonetoast3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Done. Recorded in the platform audit log.`
    );
  };

export const platformactionerrortoast3 =
  /** @type {(inputs: Platformactionerrortoast3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`That action failed. Try again.`);
  };

export const platformauditcolumnaction3 =
  /** @type {(inputs: Platformauditcolumnaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Action`);
  };

export const platformauditcolumnmeta3 =
  /** @type {(inputs: Platformauditcolumnmeta3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Details`);
  };

export const platformauditcolumnstaff3 =
  /** @type {(inputs: Platformauditcolumnstaff3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Staff`);
  };

export const platformauditcolumntime3 =
  /** @type {(inputs: Platformauditcolumntime3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Time`);
  };

export const platformauditdescription2 =
  /** @type {(inputs: Platformauditdescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Platform-level actions that touched this organization.`
    );
  };

export const platformauditempty2 =
  /** @type {(inputs: Platformauditempty2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `No platform actions on this organization yet.`
    );
  };

export const platformbacktoorgs3 =
  /** @type {(inputs: Platformbacktoorgs3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Back to organizations`);
  };

export const platformcancel1 =
  /** @type {(inputs: Platformcancel1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Cancel`);
  };

export const platformconfirm1 =
  /** @type {(inputs: Platformconfirm1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Confirm`);
  };

export const platformdisableorgaction3 =
  /** @type {(inputs: Platformdisableorgaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Disable organization`);
  };

export const platformdisableorgdescription3 =
  /** @type {(inputs: Platformdisableorgdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Every member loses access to the app. No data is deleted and you can re-enable at any time.`
    );
  };

export const platformenableorgaction3 =
  /** @type {(inputs: Platformenableorgaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Re-enable organization`);
  };

export const platformenableorgdescription3 =
  /** @type {(inputs: Platformenableorgdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Members regain access immediately.`
    );
  };

export const platformfeatureforceoff3 =
  /** @type {(inputs: Platformfeatureforceoff3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Force off`);
  };

export const platformfeatureforceon3 =
  /** @type {(inputs: Platformfeatureforceon3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Force on`);
  };

export const platformfeatureplanexcluded3 =
  /** @type {(inputs: Platformfeatureplanexcluded3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Plan default (off)`);
  };

export const platformfeatureplanincluded3 =
  /** @type {(inputs: Platformfeatureplanincluded3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Plan default (on)`);
  };

export const platformfeaturesempty2 =
  /** @type {(inputs: Platformfeaturesempty2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No feature flags defined yet.`);
  };

export const platformfeatureshint2 =
  /** @type {(inputs: Platformfeatureshint2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Leave on the plan default unless this organization needs an exception.`
    );
  };

export const platformfeatureslabel2 =
  /** @type {(inputs: Platformfeatureslabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Feature overrides`);
  };

export const platformorgdetailloaderrortitle5 =
  /** @type {(inputs: Platformorgdetailloaderrortitle5Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load this organization`);
  };

export const platformorgscolumnaicredit4 =
  /** @type {(inputs: Platformorgscolumnaicredit4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`AI credit`);
  };

export const platformorgscolumncreated3 =
  /** @type {(inputs: Platformorgscolumncreated3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Created`);
  };

export const platformorgscolumnname3 =
  /** @type {(inputs: Platformorgscolumnname3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Name`);
  };

export const platformorgscolumnowner3 =
  /** @type {(inputs: Platformorgscolumnowner3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Owner`);
  };

export const platformorgscolumnplan3 =
  /** @type {(inputs: Platformorgscolumnplan3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Plan`);
  };

export const platformorgscolumnstatus3 =
  /** @type {(inputs: Platformorgscolumnstatus3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Status`);
  };

export const platformorgsdescription2 =
  /** @type {(inputs: Platformorgsdescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Cross-tenant. Every view and every action is recorded in platform_audit_logs.`
    );
  };

export const platformorgsemptytitle3 =
  /** @type {(inputs: Platformorgsemptytitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No organizations match`);
  };

export const platformorgsloaderrortitle4 =
  /** @type {(inputs: Platformorgsloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load organizations`);
  };

export const platformorgsloading2 =
  /** @type {(inputs: Platformorgsloading2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Loading organizations…`);
  };

export const platformorgssearchplaceholder3 =
  /** @type {(inputs: Platformorgssearchplaceholder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Search name, slug or owner email`);
  };

export const platformorgsstatusactive3 =
  /** @type {(inputs: Platformorgsstatusactive3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Active`);
  };

export const platformorgsstatusall3 =
  /** @type {(inputs: Platformorgsstatusall3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`All statuses`);
  };

export const platformorgsstatusdisabled3 =
  /** @type {(inputs: Platformorgsstatusdisabled3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Disabled`);
  };

export const platformorgstitle2 =
  /** @type {(inputs: Platformorgstitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Organizations`);
  };

export const platformplanlabel2 =
  /** @type {(inputs: Platformplanlabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Plan`);
  };

export const platformreasonlabel2 =
  /** @type {(inputs: Platformreasonlabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Reason`);
  };

export const platformreasonplaceholder2 =
  /** @type {(inputs: Platformreasonplaceholder2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Why is this needed? Stored in the platform audit log.`
    );
  };

export const platformreasonsharedhint3 =
  /** @type {(inputs: Platformreasonsharedhint3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Required — it is saved with the plan change, the feature overrides and the refund assist below.`
    );
  };

export const platformrefundassistaction3 =
  /** @type {(inputs: Platformrefundassistaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Open refund request`);
  };

export const platformrefundassistdescription3 =
  /** @type {(inputs: Platformrefundassistdescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Opens a refund request on the organization's behalf. The platform never moves money — the tenant still makes the transfer.`
    );
  };

export const platformrefundassistdonetoast4 =
  /** @type {(inputs: Platformrefundassistdonetoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Refund request opened for this organization.`
    );
  };

export const platformrefundassisttitle3 =
  /** @type {(inputs: Platformrefundassisttitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Refund assist`);
  };

export const platformrefundorderidplaceholder4 =
  /** @type {(inputs: Platformrefundorderidplaceholder4Inputs) => LocalizedString} */ () => {
...
export const platformstaffaddsuccesstoast4 =
  /** @type {(inputs: Platformstaffaddsuccesstoast4Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `${i?.email} now has platform staff access.`
    );
  };
...
export const platformstaffremoveconfirmaction4 =
  /** @type {(inputs: Platformstaffremoveconfirmaction4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Remove access`);
  };

export const platformstaffremoveconfirmbody4 =
  /** @type {(inputs: Platformstaffremoveconfirmbody4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `They'll immediately lose staff access to every organization on the platform — this can't be undone from here.`
    );
  };

export const platformstaffremoveconfirmtitle4 =
  /** @type {(inputs: Platformstaffremoveconfirmtitle4Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `Remove ${i?.email}'s platform access?`
    );
  };
...
export const platformstaffremovesuccesstoast4 =
  /** @type {(inputs: Platformstaffremovesuccesstoast4Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `Removed ${i?.email}'s platform staff access.`
    );
  };
...
export const platformstataicreditspent4 =
  /** @type {(inputs: Platformstataicreditspent4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`AI credit spent`);
  };

export const platformstatcampaigns2 =
  /** @type {(inputs: Platformstatcampaigns2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Campaigns`);
  };

export const platformstatcreated2 =
  /** @type {(inputs: Platformstatcreated2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Created`);
  };

export const platformstatleads2 =
  /** @type {(inputs: Platformstatleads2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Leads`);
  };

export const platformstatmembers2 =
  /** @type {(inputs: Platformstatmembers2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Members`);
  };

export const platformstattrialuses3 =
  /** @type {(inputs: Platformstattrialuses3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Trial uses left`);
  };

export const platformsubscriptiondescription2 =
  /** @type {(inputs: Platformsubscriptiondescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Plan and per-organization feature overrides. Overrides beat the plan, both ways.`
    );
  };

export const platformsubscriptionsave2 =
  /** @type {(inputs: Platformsubscriptionsave2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Save subscription`);
  };

export const platformsubscriptiontitle2 =
  /** @type {(inputs: Platformsubscriptiontitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Subscription`);
  };

export const platformtabaudit2 =
  /** @type {(inputs: Platformtabaudit2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Audit`);
  };

export const platformtabbilling2 =
  /** @type {(inputs: Platformtabbilling2Inputs) => LocalizedString} */ () => {
...
export const productsremoveconfirmtitle3 =
...
export const productsremoveerrortoast3 =
...
export const productssaveerrortoast3 =
...
export const promptlibrarydevicedesktop3 =
  /** @type {(inputs: Promptlibrarydevicedesktop3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Desktop`);
  };

export const promptlibrarydevicemobile3 =
  /** @type {(inputs: Promptlibrarydevicemobile3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Mobile`);
  };

export const promptlibrarydevicetablet3 =
  /** @type {(inputs: Promptlibrarydevicetablet3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Tablet`);
  };

export const promptlibraryemptytitle3 =
  /** @type {(inputs: Promptlibraryemptytitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No prompts yet`);
  };

export const promptlibraryfullpromptsection4 =
  /** @type {(inputs: Promptlibraryfullpromptsection4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Full prompt`);
  };

export const promptlibrarygeneratecta3 =
  /** @type {(inputs: Promptlibrarygeneratecta3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Generate with our AI`);
  };

export const promptlibrarygeneratedialogdescription4 =
  /** @type {(inputs: Promptlibrarygeneratedialogdescription4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Fill in the blanks in the prompt below before generating — the AI will use exactly this text to build the new page.`
    );
  };

export const promptlibrarygeneratedialogtitle4 =
  /** @type {(inputs: Promptlibrarygeneratedialogtitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Generate a page with our AI`);
  };

export const promptlibrarygeneratenamelabel4 =
  /** @type {(inputs: Promptlibrarygeneratenamelabel4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Page name`);
  };

export const promptlibrarygeneratepromptlabel4 =
  /** @type {(inputs: Promptlibrarygeneratepromptlabel4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Prompt text`);
  };

export const promptlibrarygeneratesubmit3 =
  /** @type {(inputs: Promptlibrarygeneratesubmit3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Generate page`);
  };

export const promptlibrarygeneratesubmitting3 =
  /** @type {(inputs: Promptlibrarygeneratesubmitting3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Generating…`);
  };

export const promptlibraryimportcta3 =
  /** @type {(inputs: Promptlibraryimportcta3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Already have HTML? Import it`);
  };

export const promptlibraryloaderrortitle4 =
  /** @type {(inputs: Promptlibraryloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load the prompt library`);
  };

export const promptlibrarynopreview3 =
  /** @type {(inputs: Promptlibrarynopreview3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No preview yet`);
  };

export const promptlibrarypreviewsection3 =
  /** @type {(inputs: Promptlibrarypreviewsection3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Preview`);
  };

export const promptlibrarysearchplaceholder3 =
  /** @type {(inputs: Promptlibrarysearchplaceholder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Search prompts`);
  };

export const promptlibrarysummarysection3 =
  /** @type {(inputs: Promptlibrarysummarysection3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Summary`);
  };

export const promptlibrarytitle2 =
  /** @type {(inputs: Promptlibrarytitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Prompt library`);
  };

export const promptlibraryusetemplatecta4 =
  /** @type {(inputs: Promptlibraryusetemplatecta4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Use this template`);
  };

export const promptlibraryusetemplatesubmitting4 =
  /** @type {(inputs: Promptlibraryusetemplatesubmitting4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Creating…`);
  };

export const prompttemplateaddsection3 =
  /** @type {(inputs: Prompttemplateaddsection3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add section`);
  };

export const prompttemplateaddvariable3 =
  /** @type {(inputs: Prompttemplateaddvariable3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add variable`);
  };

export const prompttemplatecolumnslug3 =
  /** @type {(inputs: Prompttemplatecolumnslug3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Slug`);
  };

export const prompttemplatecolumntype3 =
  /** @type {(inputs: Prompttemplatecolumntype3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Type`);
  };

export const prompttemplatecolumnversion3 =
  /** @type {(inputs: Prompttemplatecolumnversion3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Version`);
  };

export const prompttemplatecompareheading3 =
  /** @type {(inputs: Prompttemplatecompareheading3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Comparing 2 runs`);
  };

export const prompttemplatecompareselect3 =
  /** @type {(inputs: Prompttemplatecompareselect3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Compare`);
  };

export const prompttemplatecompilebutton3 =
  /** @type {(inputs: Prompttemplatecompilebutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Compile`);
  };

export const prompttemplatecompileerrortoast4 =
...
export const prompttemplateremoveconfirmtitle4 =
...
export const prompttemplateremoveerrortoast4 =
...
export const reconciliationsearchbutton2 =
  /** @type {(inputs: Reconciliationsearchbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Search`);
  };

export const reconciliationsearcherrortoast3 =
...
export const reconciliationselectorderaction3 =
  /** @type {(inputs: Reconciliationselectorderaction3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Assign to this order`);
  };

export const reconciliationsummaryalreadypaid3 =
  /** @type {(inputs: Reconciliationsummaryalreadypaid3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Order already paid`);
  };

export const reconciliationsummaryambiguous2 =
  /** @type {(inputs: Reconciliationsummaryambiguous2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Multiple possible orders`);
  };

export const reconciliationsummarynocandidate3 =
  /** @type {(inputs: Reconciliationsummarynocandidate3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No order found`);
  };

export const reconciliationsummarytitle2 =
  /** @type {(inputs: Reconciliationsummarytitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Needs action`);
  };

export const reconciliationtitle1 =
  /** @type {(inputs: Reconciliationtitle1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Orders to confirm`);
  };

export const refundrequestscolumnamount3 =
  /** @type {(inputs: Refundrequestscolumnamount3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Amount`);
  };

export const refundrequestscolumnlead3 =
  /** @type {(inputs: Refundrequestscolumnlead3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Lead`);
  };

export const refundrequestscolumnorder3 =
  /** @type {(inputs: Refundrequestscolumnorder3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Order`);
  };

export const refundrequestscolumnreason3 =
  /** @type {(inputs: Refundrequestscolumnreason3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Reason`);
  };

export const refundrequestscolumnstatus3 =
  /** @type {(inputs: Refundrequestscolumnstatus3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Status`);
  };

export const refundrequestscompleteerrortoast4 =
...
export const refundrequestsdescription2 =
...
export const refundrequestsreasoncustomer3 =
  /** @type {(inputs: Refundrequestsreasoncustomer3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Customer request`);
  };

export const refundrequestsreasonduplicatepayment4 =
  /** @type {(inputs: Refundrequestsreasonduplicatepayment4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Duplicate payment`);
  };

export const refundrequestsreasonother3 =
  /** @type {(inputs: Refundrequestsreasonother3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Other`);
  };

export const refundrequestsreasonwrongmatch4 =
  /** @type {(inputs: Refundrequestsreasonwrongmatch4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Wrong order match`);
  };

export const refundrequestsrejectbutton3 =
  /** @type {(inputs: Refundrequestsrejectbutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Reject`);
  };

export const refundrequestsrejectconfirmaction4 =
  /** @type {(inputs: Refundrequestsrejectconfirmaction4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Reject refund`);
  };

export const refundrequestsrejectconfirmbody4 =
  /** @type {(inputs: Refundrequestsrejectconfirmbody4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `The order keeps its current status — use this when the customer isn't actually owed a refund. This can't be undone.`
    );
  };

export const refundrequestsrejectconfirmtitle4 =
  /** @type {(inputs: Refundrequestsrejectconfirmtitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Reject this refund request?`);
  };

export const refundrequestsrejecterrortoast4 =
  /** @type {(inputs: Refundrequestsrejecterrortoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Couldn't reject this refund. Try again.`
    );
  };

export const refundrequestsremitterlabel3 =
  /** @type {(inputs: Refundrequestsremitterlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Remitter`);
  };

export const refundrequestsstatuscompleted3 =
  /** @type {(inputs: Refundrequestsstatuscompleted3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Completed`);
  };

export const refundrequestsstatuspending3 =
  /** @type {(inputs: Refundrequestsstatuspending3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Pending`);
  };

export const refundrequestsstatusprocessing3 =
  /** @type {(inputs: Refundrequestsstatusprocessing3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Processing`);
  };

export const refundrequestsstatusrejected3 =
  /** @type {(inputs: Refundrequestsstatusrejected3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Rejected`);
  };

export const refundrequeststitle2 =
  /** @type {(inputs: Refundrequeststitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Refund requests`);
  };

export const refundrequestsuploaderrortoast4 =
...
export const skillsaveerrortoast3 =
...
export const skillsluglabel2 =
  /** @type {(inputs: Skillsluglabel2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Slug`);
  };

export const skilltoggledefaulterrortoast4 =
...
export const studioautosavesaving2 =
  /** @type {(inputs: Studioautosavesaving2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Saving…`);
  };

export const studiobacktocustomimport4 =
  /** @type {(inputs: Studiobacktocustomimport4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Back to import settings`);
  };

export const studiochatemptydescription3 =
...
export const studiochatsuggestionheadline3 =
...
export const studiofileslightboxempty3 =
...
export const studiofunnelgapsseodescription4 =
...
export const studiogenerateerrorinsufficientcreditstitle5 =
...
export const studiogenerateerrornoaiconnectiondescription6 =
...
export const studiogenerateerrornoaiconnectiontitle6 =
...
export const studiogenerateerrortrialexhausteddescription5 =
...
export const studiolayersdragdisabledhint4 =
  /** @type {(inputs: Studiolayersdragdisabledhint4Inputs) => LocalizedString} */ (
    i
  ) => {
    return /** @type {LocalizedString} */ (
      `Drag-to-reorder is off above ${i?.threshold} layers on this page — use the eye icon to hide instead.`
    );
  };

export const studiolayersfooterhint3 =
...
export const studiomoreactionslabel3 =
  /** @type {(inputs: Studiomoreactionslabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Project actions`);
  };

export const studionativechatsuggestionheadline4 =
  /** @type {(inputs: Studionativechatsuggestionheadline4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Rewrite the Hero headline to be punchier`
    );
  };

export const studionativechatsuggestiontestimonial4 =
  /** @type {(inputs: Studionativechatsuggestiontestimonial4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Add a testimonial section`);
  };

export const studionativechatsuggestiontone4 =
  /** @type {(inputs: Studionativechatsuggestiontone4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Make the tone more formal`);
  };

export const studionativechattooltitle4 =
  /** @type {(inputs: Studionativechattooltitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Update page`);
  };

export const studionew1 =
  /** @type {(inputs: Studionew1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`New`);
  };

export const studiopresent1 =
  /** @type {(inputs: Studiopresent1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Present`);
  };

export const studiopreviewbutton2 =
  /** @type {(inputs: Studiopreviewbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Preview`);
  };

export const studiopreviewerrortoast3 =
  /** @type {(inputs: Studiopreviewerrortoast3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Couldn't build the preview. Try again.`
    );
  };

export const studiopublishanywaybutton3 =
  /** @type {(inputs: Studiopublishanywaybutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Publish anyway`);
  };

export const studiopublishattachcampaignbutton4 =
  /** @type {(inputs: Studiopublishattachcampaignbutton4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Attach`);
  };

export const studiopublishauditrequiredtoast4 =
  /** @type {(inputs: Studiopublishauditrequiredtoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Run a quality audit before publishing this page.`
    );
  };

export const studiopublishauditthresholdtoast4 =
  /** @type {(inputs: Studiopublishauditthresholdtoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `This page hasn't reached the minimum quality bar yet — open the Quality panel to see and fix the issues.`
    );
  };

export const studiopublishbutton2 =
  /** @type {(inputs: Studiopublishbutton2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Publish`);
  };

export const studiopublishcampaignattacherrortoast5 =
...
export const studiopublishdialogtitle3 =
  /** @type {(inputs: Studiopublishdialogtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Publish`);
  };

export const studiopublisherrortoast3 =
  /** @type {(inputs: Studiopublisherrortoast3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't publish. Try again.`);
  };

export const studiopublishnocampaignwarning4 =
  /** @type {(inputs: Studiopublishnocampaignwarning4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `This page has a signup form, but isn't linked to a campaign yet. Without one, the form has no fields, no payment setup, and nothing to submit into. Attach a campaign now, or publish anyway if this page really doesn't need one.`
    );
  };

export const studiopublishsubdomainlabel3 =
  /** @type {(inputs: Studiopublishsubdomainlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Subdomain`);
  };

export const studiopublishsubdomaintakentoast4 =
  /** @type {(inputs: Studiopublishsubdomaintakentoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Another organization already has this subdomain. Pick a different one.`
    );
  };

export const studiopublishsuccesstoast3 =
...
export const studiopublishunverifiedassetstoast4 =
  /** @type {(inputs: Studiopublishunverifiedassetstoast4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Some imported images have unconfirmed usage rights — confirm them before publishing.`
    );
  };

export const studiopublishupdatebutton3 =
  /** @type {(inputs: Studiopublishupdatebutton3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Publish update`);
  };

export const studiorenameerrortoast3 =
...
export const studioseonoindexhint3 =
  /** @type {(inputs: Studioseonoindexhint3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Adds a noindex tag and drops the page from its sitemap.`
    );
  };

export const studioseonoindexlabel3 =
  /** @type {(inputs: Studioseonoindexlabel3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Hide from search engines`);
  };

export const studioseoogimagelabel4 =
  /** @type {(inputs: Studioseoogimagelabel4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Share image (OG image)`);
  };

export const studioseopaneltitle3 =
  /** @type {(inputs: Studioseopaneltitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`SEO`);
  };

export const studioseosharepreviewlabel4 =
  /** @type {(inputs: Studioseosharepreviewlabel4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Facebook / Zalo share preview`);
  };

export const studioseosharepreviewnoimage5 =
  /** @type {(inputs: Studioseosharepreviewnoimage5Inputs) => LocalizedString} */ () => {
...
export const studioskillspopovertitle3 =
  /** @type {(inputs: Studioskillspopovertitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Skills for this page`);
  };

export const studioskillstoggleerrortoast4 =
...
export const studioversionviewchatbutton4 =
  /** @type {(inputs: Studioversionviewchatbutton4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`View chat message`);
  };

export const todaycreatefirstoffer3 =
  /** @type {(inputs: Todaycreatefirstoffer3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create your first offer`);
  };

export const todaycreateoffer2 =
  /** @type {(inputs: Todaycreateoffer2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Create offer`);
  };

export const todaydescription1 =
  /** @type {(inputs: Todaydescription1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `See new leads, payments to review, and offers that are ready to run.`
    );
  };

export const todayerrortitle2 =
  /** @type {(inputs: Todayerrortitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Could not load today's work`);
  };

export const todayeyebrow1 =
  /** @type {(inputs: Todayeyebrow1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Đơn Về`);
  };

export const todaygettingstarteddescription3 =
  /** @type {(inputs: Todaygettingstarteddescription3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Create a selling flow, share the link, and start collecting leads.`
    );
  };

export const todaygettingstartedtitle3 =
  /** @type {(inputs: Todaygettingstartedtitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Start with an offer`);
  };

export const todayliveoffers2 =
  /** @type {(inputs: Todayliveoffers2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Live offers`);
  };

export const todayloading1 =
  /** @type {(inputs: Todayloading1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Loading your work queue`);
  };

export const todaynextsteptitle3 =
  /** @type {(inputs: Todaynextsteptitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Next step`);
  };

export const todaynextstepwithoffer4 =
  /** @type {(inputs: Todaynextstepwithoffer4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Share a live offer and follow new leads in the Inbox.`
    );
  };

export const todaynextstepwithoutoffer4 =
  /** @type {(inputs: Todaynextstepwithoutoffer4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Create your first offer to start collecting leads.`
    );
  };

export const todayopenaction2 =
  /** @type {(inputs: Todayopenaction2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Open`);
  };

export const todayqueuedescription2 =
  /** @type {(inputs: Todayqueuedescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Ranked by urgency: money already collected but not fulfilled first, then new leads, then unmatched payments.`
    );
  };

export const todayqueueempty2 =
  /** @type {(inputs: Todayqueueempty2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Nothing left in the queue. You can focus on new content.`
    );
  };

export const todayqueuetitle2 =
  /** @type {(inputs: Todayqueuetitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Needs your attention`);
  };

export const todaysystemready2 =
  /** @type {(inputs: Todaysystemready2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Your operational connections are ready for the next step.`
    );
  };

export const todaysystemstatus2 =
  /** @type {(inputs: Todaysystemstatus2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`System status`);
  };

export const todaytitle1 =
  /** @type {(inputs: Todaytitle1Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`What needs your attention today?`);
  };

export const usageinsightsbyeventtitle4 =
  /** @type {(inputs: Usageinsightsbyeventtitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`By action type`);
  };

export const usageinsightscolumncount3 =
  /** @type {(inputs: Usageinsightscolumncount3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Count`);
  };

export const usageinsightscolumnevent3 =
  /** @type {(inputs: Usageinsightscolumnevent3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Action type`);
  };

export const usageinsightsdescription2 =
  /** @type {(inputs: Usageinsightsdescription2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (
      `Which features you've used in the last 30 days — internal data, visible only to you.`
    );
  };

export const usageinsightsemptytitle3 =
  /** @type {(inputs: Usageinsightsemptytitle3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`No usage data yet`);
  };

export const usageinsightsloaderrortitle4 =
  /** @type {(inputs: Usageinsightsloaderrortitle4Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Couldn't load usage data`);
  };

export const usageinsightstitle2 =
  /** @type {(inputs: Usageinsightstitle2Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Platform usage`);
  };

export const usageinsightstotalevents3 =
  /** @type {(inputs: Usageinsightstotalevents3Inputs) => LocalizedString} */ () => {
    return /** @type {LocalizedString} */ (`Total actions`);
  };

export const verifiedbody1 =
...
export const verifyemailtitle2 =
