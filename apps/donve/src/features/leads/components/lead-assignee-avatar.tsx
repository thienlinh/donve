...
export function LeadAssigneeAvatar({
  ...
  // Renders a muted dash instead of an empty cell — otherwise "unassigned" is indistinguishable
  // from the avatar just not having loaded yet.
  if (!assigneeId) return <span className="text-muted-foreground">—</span>;
