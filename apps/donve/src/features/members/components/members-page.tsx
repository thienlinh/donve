              ...
              <Table>
                ...
                <TableBody>
                  {pendingInvitations.map((invitation) => {
                    ...
                    // oxlint-disable-next-line react-doctor/rendering-hydration-mismatch-time, react/purity -- this client-only Vite SPA (tech-stack.md) is never server-rendered, so there's no hydration pass for `Date.now()` to mismatch against; re-evaluating "expired" on each render is the intended behavior here.
