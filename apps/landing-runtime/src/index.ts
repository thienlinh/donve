...
if (config) {
  ...
  // "view" kept for the legacy campaign analytics bucket; "page_viewed" is the new
  // conversion-hierarchy name (`tracking-and-attribution.md`), carrying first-touch UTM.
