...
- [x] "Tạo `packages/auth`: Better Auth + organization plugin + RBAC theo bảng quyền ở `docs/architecture/architecture.md` §6 (owner/admin/editor/sales) — FR-A-01 đến FR-A-04."
