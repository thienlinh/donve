...
- **SEO (15%)** — crawlability (robots.txt/sitemap — mostly N/A for the authenticated dashboard, applies to public landing pages), title/heading structure, mobile responsiveness, structured data on public pages.
...
Run this pass after any dashboard page redesign, and especially after any landing-page PageSpec/template work in `packages/studio-catalog` / `packages/studio-render` since those ship to real visitors (unlike the internal dashboard).
