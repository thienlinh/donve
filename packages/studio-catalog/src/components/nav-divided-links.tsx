...
export const navDividedLinksPropsSchema = z.object({
  logoText: z.string(),
...
export type NavDividedLinksProps = z.infer<typeof navDividedLinksPropsSchema>;

export function NavDividedLinksRender({
  props
}: BaseComponentProps<NavDividedLinksProps>) {
  return (
    <header
      data-lp-component="nav_divided_links"
    ...
    >
      ...
      <nav className="flex flex-wrap items-center justify-center border-[var(--lp-color-border)] text-base md:mr-auto md:ml-4 md:border-l md:py-1 md:pl-4">
...
export const navDividedLinksMeta: ComponentMeta = {
  componentId: "nav_divided_links",
  category: "Nav",
  variants: [],
